...
if __name__ == '__main__':
    ...
    music_file="/global/cscratch1/sd/djbard/MUSIC_pyCola/ohahn-music-12e7b54e7512/fidu.hdf5" 
    ...
    ## this seems to be purely parameter setting. 
    ...
    print "cellsize", cellsize, cellsize_zoom ## both are zero
    print "bbox", BBox_out
    print BBox_out_zoom ## same size as BB_out - [0, 256]^3
    print "grid", ngrid_x, gridcellsize ### 768 ngrid, and gridcellsize is 1/3. I presume that's because I set gridscale=3. That's not related to anything in Music.

 
    ### perhaps I can set these params by hand to give a non-existance zoom? 

    #BBox_out_zoom =  np.array( [[0,0], [0,0], [0,0]], dtype='int32')
    #cellsize_zoom = 0.0 ### ic_2lpt needs to have sy2_full_zoom values removed if I do this, as it will try to return 3 values if cellsize_zoom=0
    ### but, might just be easiest to not evolve the zoom particles? 
    ...
    ### try setting there to be no zoom now...
    cellsize_zoom=0
    px, py, pz, vx, vy, vz, \
...
### don't know what htis is - perhaps it could be zero? 
    ...
    CICDeposit_3(
                     ...
                     pz, 
                     px,py,pz, #dummies
                     density, ### the actual useful output!!! 
